// Full dataset of Nigeria's 36 states + FCT and all 774 Local Government Areas
...
export const STATE_LGA_MAP: Record<string, string[]> = {
  ...
  'Jigawa': [
    'Babura', 'Biriniwa', 'Birnin Kudu', 'Buji', 'Dutse', 'Gagarawa',
  ...
  'Kaduna': [
    ...
    'Kajuru', 'Kaura', 'Kauru', 'Kubau', 'Kudan', 'Lere', 'Makafrfi',
  ...
  'Kano': [
    ...
    'Kiru', 'Kumbotso', 'Kunchi', 'Kura', 'Madobi', 'Minjibir',
  ...
  'Zamfara': [
    ...
    'Talata Mafara', 'Chasfe', 'Zurmi',
  ],
};

// Get first LGA of a state for fallback/default
export function getDefaultLga(state: string): string {
  const lgas = STATE_LGA_MAP[state];
  return lgas && lgas.length > 0 ? lgas[0] : '';
}